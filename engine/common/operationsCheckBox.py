...
class EditorOperationCheckBox():
    ...
    def __init__(self, **kwargs):
        ...
        # isActiveCheckBox
        self.isActiveCheckBox = CheckBox(size_hint=(1,None), height=30)
        content.add_widget(self.isActiveCheckBox)
    ...
    def oAdd(self, instance):
        ...
        calculatedCheckBoxData = {
            "id": str(uuid.uuid4()),
            "name": self.buttonNameText.text,
            "type": "CHECKBOX",
            "text": self.buttonText.text,
            "active": self.isActiveCheckBox.active,
        ...
        print("calculatedCheckBoxData on local call -> ", calculatedCheckBoxData)
        ...
        if self.store.exists('renderComponentArray'):
            ...
            if self.currentLayout == 'SCENE_ROOT':
                localStagedElements.append(calculatedCheckBoxData)
            else:
                TEST = self._add(localStagedElements, calculatedCheckBoxData , self.currentLayout)
